...
const positioner = {
     ...
     */
    _calculateXAlign(windowBounds: Rectangle, trayBounds: Rectangle, align: string): number {
        const display = this._getDisplay(trayBounds);
        let x;
     ...
     */
    _calculateYAlign(windowBounds: Rectangle, trayBounds: Rectangle, align: string): number {
        const display = this._getDisplay(trayBounds);
        let y;
     ...
     * @return {Point} - Calculated point {x, y} where the window should be positioned
     */
    _calculateByCursorPosition(windowBounds: Rectangle, display: Display, cursor: Point): Point {
